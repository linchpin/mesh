...
multiple_content_sections.admin = function ($) {
    ...
    var $doc = $(document),
        ...
        // Temporarily saving display data for tinymce
        default_tinymce_data = {
            theme: "modern",
            skin: "lightgray",
            language: "en",
            formats: {
    ...
    return {
         ...
         * @param event
         */
        toggle_expand_all_sections: function (event) {
            ...
            $.post(ajaxurl, {
                ...
                if (response) {
                    ...
                    if ( $('#mcs-section-editor-' + section_id + '-support').length > 0 ) {
                        var support_tinymce_data = default_tinymce_data;
                            support_tinymce_data.selector = '#mcs-section-editor-' + section_id + '-support';

                        tinymce.init( support_tinymce_data );
                    }
        ...
        /**
         * Utility method to reset the helper message to the default
         * Typically used to reset the messages after a save timer
         *
         * @since 1.3.0
         */
        reset_default_notification: function() {
            multiple_content_sections.admin.update_notifications( 'description', 'info' );
        },

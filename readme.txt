...
Tags: sections, content, page, posts, custom post type, easy, editor
...
Mesh is also compatible with Linchpin’s [Toggle wpautop](https://wordpress.org/plugins/toggle-wpautop/) plugin.

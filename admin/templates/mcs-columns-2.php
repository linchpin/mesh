...
?>
<div class="mcs-columns-<?php esc_attr_e( $block_columns ); ?> columns" id="mcs-block-ui-sorting-1">
...
<div class="mcs-columns-<?php esc_attr_e( $block_column_2 ); ?> columns" id="mcs-block-ui-sorting-1">
	<div class="drop-target">

    ...
    <div class="mesh welcome-panel-content">
        ...
        <div class="welcome-panel-column-container">
            ...
            <div class="welcome-panel-column">
                ...
                <ul>
                    <li><?php printf( '<a href="%s" class="welcome-icon welcome-learn-more" target="_blank">' . __( 'Learn more about Mesh', 'mesh' ) . '</a>', esc_url( __( 'https://github.com/linchpin/mesh', 'mesh' ) ) ); ?></li>
                    ...
                    <li><?php printf( '<a href="%s" class="welcome-icon welcome-view-github icon-github" target="_blank">' . __( 'View Features Requests', 'mesh' ) . '</a>', esc_url( __( 'https://github.com/linchpin/mesh/issues', 'mesh' ) ) ); ?></li>
                </ul>
            </div>
        </div>
    </div>

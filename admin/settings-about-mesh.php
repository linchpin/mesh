            ...
            <div class="wrapper">
                ...
                <div class="about-devs-container grey-box">
                    <div class="padding-box">
                        ...
                        <p>
                            <?php
                            printf( 'Check our our <a href="%s">site</a>, connect with us or come say hi at a local event.', esc_url( 'http://linchpin.agency' ) );
                            ?>
                        </p>

                        <p class="no-margin"><?php printf( '<a href="%s">%s</a>', esc_url( 'http://linchpin.agency' ), esc_html( 'Linchpin.Agency' ) ); ?>   |   <a href="https://jetpack.pro/profile/linchpin/">Jetpack.pro</a>   |   <a href="https://facebook.com/linchpinagency">Facebook</a>   |   <a href="https://twitter.com/linchpin_agency">Twitter</a>   |   <a href="https://www.instagram.com/linchpinagency/">Instagram</a></p>
                    </div>
                </div>
            </div>
        </div>
